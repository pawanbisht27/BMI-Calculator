    ...
    return Scaffold(
        ...
        body:Container(
          decoration: BoxDecoration(
             gradient: LinearGradient  (           //check this
             // gradient: RadialGradient(       //cut
                colors: [
              Color(0xff5ee7df),
                  Color(0xffb490ca),
            ],
              //    center: Alignment.bottomCenter               //cut
               begin: FractionalOffset(1.0, 0.5),           //check this
              end: FractionalOffset(0.0, 0.5),              //check this
            )
          ),
          child: Center(
            child: Container(
